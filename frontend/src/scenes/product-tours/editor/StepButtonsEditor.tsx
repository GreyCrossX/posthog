        ...
        return (
            <div className="flex gap-4">
                <div className="flex-1 space-y-2">
                    <div className="text-xs font-semibold text-muted uppercase tracking-wide">Primary</div>
                    <ButtonEditor
                        label=""
                ...
                <div className="flex-1 space-y-2">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-muted uppercase tracking-wide">Secondary</span>
                        <LemonSwitch checked={!!secondaryButton} onChange={toggleSecondaryButton} size="small" />
                    </div>
                    {secondaryButton ? (
                        <ButtonEditor
                            label=""
